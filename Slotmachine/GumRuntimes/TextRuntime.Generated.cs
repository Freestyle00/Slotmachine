    ...
    namespace Slotmachine.GumRuntimes
    {
        public partial class TextRuntime : Gum.Wireframe.GraphicalUiElement
        {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.TextRuntime.VariableState fromState,Slotmachine.GumRuntimes.TextRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.TextRuntime.ColorCategory fromState,Slotmachine.GumRuntimes.TextRuntime.ColorCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
