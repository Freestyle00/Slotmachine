    ...
    {
        public partial class ButtonRuntime : Slotmachine.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime.VariableState fromState,Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime.ButtonCategory fromState,Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime.ButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Slotmachine.GumRuntimes.RectangleRuntime HighlightRectangle { get; set; }
            public string Text
            {
                get
                {
            ...
            private void AssignReferences () 
            {
                ...
                HighlightRectangle = this.GetGraphicalUiElementByName("HighlightRectangle") as Slotmachine.GumRuntimes.RectangleRuntime;
            }
