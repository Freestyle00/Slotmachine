    ...
    {
        public partial class ComboBoxRuntime : Slotmachine.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentComboBoxCategoryState)
                        {
                            ...
                            case  ComboBoxCategory.Disabled:
                                NineSliceInstance.CurrentColorCategoryState = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                TextInstance.CurrentColorCategoryState = Slotmachine.GumRuntimes.TextRuntime.ColorCategory.Gray;
                                NineSliceInstance.Blue = 255;
                                NineSliceInstance.Green = 255;
                                NineSliceInstance.Red = 255;
                            ...
                            case  ComboBoxCategory.Highlighted:
                                NineSliceInstance.CurrentColorCategoryState = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
            ...
            public void InterpolateBetween (ComboBoxCategory firstState, ComboBoxCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueFirstValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateFirstValue = true;
                        NineSliceInstanceCurrentColorCategoryStateFirstValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenFirstValue = true;
                        NineSliceInstanceGreenFirstValue = 255;
                        setNineSliceInstanceRedFirstValue = true;
                        NineSliceInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    ...
                    case  ComboBoxCategory.Disabled:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
                    ...
                    case  ComboBoxCategory.Highlighted:
                        ...
                        NineSliceInstanceBlueSecondValue = 255;
                        setNineSliceInstanceCurrentColorCategoryStateSecondValue = true;
                        NineSliceInstanceCurrentColorCategoryStateSecondValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setNineSliceInstanceGreenSecondValue = true;
                        NineSliceInstanceGreenSecondValue = 255;
                        setNineSliceInstanceRedSecondValue = true;
                        NineSliceInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState fromState,Slotmachine.GumRuntimes.DefaultForms.ComboBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory fromState,Slotmachine.GumRuntimes.DefaultForms.ComboBoxRuntime.ComboBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Slotmachine.GumRuntimes.DefaultForms.ListBoxRuntime ListBoxInstance { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime NineSliceInstance { get; set; }
            public Slotmachine.GumRuntimes.TextRuntime TextInstance { get; set; }
            public Slotmachine.GumRuntimes.SpriteRuntime SpriteInstance { get; set; }
            ...
            {
                ListBoxInstance = this.GetGraphicalUiElementByName("ListBoxInstance") as Slotmachine.GumRuntimes.DefaultForms.ListBoxRuntime;
                NineSliceInstance = this.GetGraphicalUiElementByName("NineSliceInstance") as Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                TextInstance = this.GetGraphicalUiElementByName("TextInstance") as Slotmachine.GumRuntimes.TextRuntime;
                SpriteInstance = this.GetGraphicalUiElementByName("SpriteInstance") as Slotmachine.GumRuntimes.SpriteRuntime;
