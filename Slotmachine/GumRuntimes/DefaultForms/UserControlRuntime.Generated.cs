    ...
    {
        public partial class UserControlRuntime : Slotmachine.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ColoredFrameInstance.CurrentColorCategoryState = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
                            Height = 300f;
                            Width = 300f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.UserControlRuntime.VariableState fromState,Slotmachine.GumRuntimes.DefaultForms.UserControlRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
