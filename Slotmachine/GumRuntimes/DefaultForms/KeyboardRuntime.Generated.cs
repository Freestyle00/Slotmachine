    ...
    {
        public partial class KeyboardRuntime : Slotmachine.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.KeyboardRuntime.VariableState fromState,Slotmachine.GumRuntimes.DefaultForms.KeyboardRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.KeyboardRuntime.CursorMoveCategory fromState,Slotmachine.GumRuntimes.DefaultForms.KeyboardRuntime.CursorMoveCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Slotmachine.GumRuntimes.ContainerRuntime Row1Keys { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime KeyRows { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key1 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyQ { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyA { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyZ { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyParenLeft { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyW { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyS { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyX { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyParenRight { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyE { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyD { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyC { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeySpace { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyR { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyF { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyV { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyT { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyG { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyB { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyY { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyH { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyN { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyU { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyJ { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyM { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyI { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyK { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyComma { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyQuestion { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyO { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyL { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyPeriod { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyBang { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyP { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyUnderscore { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyHyphen { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyAmpersand { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key2 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key3 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key4 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key5 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key6 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key7 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key8 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key9 { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime Key0 { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime Row2Keys { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime Row3Keys { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime Row4Keys { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime Row5Keys { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime KeyBackspace { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime KeyReturn { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyLeft { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime KeyRight { get; set; }
            ...
            {
                Row1Keys = this.GetGraphicalUiElementByName("Row1Keys") as Slotmachine.GumRuntimes.ContainerRuntime;
                KeyRows = this.GetGraphicalUiElementByName("KeyRows") as Slotmachine.GumRuntimes.ContainerRuntime;
                Key1 = this.GetGraphicalUiElementByName("Key1") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyQ = this.GetGraphicalUiElementByName("KeyQ") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyA = this.GetGraphicalUiElementByName("KeyA") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyZ = this.GetGraphicalUiElementByName("KeyZ") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyParenLeft = this.GetGraphicalUiElementByName("KeyParenLeft") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyW = this.GetGraphicalUiElementByName("KeyW") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyS = this.GetGraphicalUiElementByName("KeyS") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyX = this.GetGraphicalUiElementByName("KeyX") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyParenRight = this.GetGraphicalUiElementByName("KeyParenRight") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyE = this.GetGraphicalUiElementByName("KeyE") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyD = this.GetGraphicalUiElementByName("KeyD") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyC = this.GetGraphicalUiElementByName("KeyC") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeySpace = this.GetGraphicalUiElementByName("KeySpace") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyR = this.GetGraphicalUiElementByName("KeyR") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyF = this.GetGraphicalUiElementByName("KeyF") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyV = this.GetGraphicalUiElementByName("KeyV") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyT = this.GetGraphicalUiElementByName("KeyT") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyG = this.GetGraphicalUiElementByName("KeyG") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyB = this.GetGraphicalUiElementByName("KeyB") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyY = this.GetGraphicalUiElementByName("KeyY") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyH = this.GetGraphicalUiElementByName("KeyH") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyN = this.GetGraphicalUiElementByName("KeyN") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyU = this.GetGraphicalUiElementByName("KeyU") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyJ = this.GetGraphicalUiElementByName("KeyJ") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyM = this.GetGraphicalUiElementByName("KeyM") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyI = this.GetGraphicalUiElementByName("KeyI") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyK = this.GetGraphicalUiElementByName("KeyK") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyComma = this.GetGraphicalUiElementByName("KeyComma") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyQuestion = this.GetGraphicalUiElementByName("KeyQuestion") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyO = this.GetGraphicalUiElementByName("KeyO") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyL = this.GetGraphicalUiElementByName("KeyL") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyPeriod = this.GetGraphicalUiElementByName("KeyPeriod") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyBang = this.GetGraphicalUiElementByName("KeyBang") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyP = this.GetGraphicalUiElementByName("KeyP") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyUnderscore = this.GetGraphicalUiElementByName("KeyUnderscore") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyHyphen = this.GetGraphicalUiElementByName("KeyHyphen") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyAmpersand = this.GetGraphicalUiElementByName("KeyAmpersand") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key2 = this.GetGraphicalUiElementByName("Key2") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key3 = this.GetGraphicalUiElementByName("Key3") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key4 = this.GetGraphicalUiElementByName("Key4") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key5 = this.GetGraphicalUiElementByName("Key5") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key6 = this.GetGraphicalUiElementByName("Key6") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key7 = this.GetGraphicalUiElementByName("Key7") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key8 = this.GetGraphicalUiElementByName("Key8") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key9 = this.GetGraphicalUiElementByName("Key9") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Key0 = this.GetGraphicalUiElementByName("Key0") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                Row2Keys = this.GetGraphicalUiElementByName("Row2Keys") as Slotmachine.GumRuntimes.ContainerRuntime;
                Row3Keys = this.GetGraphicalUiElementByName("Row3Keys") as Slotmachine.GumRuntimes.ContainerRuntime;
                Row4Keys = this.GetGraphicalUiElementByName("Row4Keys") as Slotmachine.GumRuntimes.ContainerRuntime;
                Row5Keys = this.GetGraphicalUiElementByName("Row5Keys") as Slotmachine.GumRuntimes.ContainerRuntime;
                KeyBackspace = this.GetGraphicalUiElementByName("KeyBackspace") as Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime;
                KeyReturn = this.GetGraphicalUiElementByName("KeyReturn") as Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime;
                KeyLeft = this.GetGraphicalUiElementByName("KeyLeft") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
                KeyRight = this.GetGraphicalUiElementByName("KeyRight") as Slotmachine.GumRuntimes.DefaultForms.KeyboardKeyRuntime;
