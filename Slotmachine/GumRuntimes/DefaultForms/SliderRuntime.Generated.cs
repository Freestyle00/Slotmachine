    ...
    {
        public partial class SliderRuntime : Slotmachine.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.SliderRuntime.VariableState fromState,Slotmachine.GumRuntimes.DefaultForms.SliderRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,Slotmachine.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime TrackInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ...
                TrackInstance = this.GetGraphicalUiElementByName("TrackInstance") as Slotmachine.GumRuntimes.ContainerRuntime;
