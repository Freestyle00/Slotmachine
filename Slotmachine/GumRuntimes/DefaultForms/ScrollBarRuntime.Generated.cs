    ...
    {
        public partial class ScrollBarRuntime : Slotmachine.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            BackgroundInstance.CurrentColorCategoryState = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                            Height = 384f;
                            Width = 36f;
                            X = 0f;
                            Y = 0f;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = Slotmachine.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState fromState,Slotmachine.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (Slotmachine.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory fromState,Slotmachine.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            public Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime UpButtonInstance { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime DownButtonInstance { get; set; }
            public Slotmachine.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            public Slotmachine.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            public Slotmachine.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            public Slotmachine.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as Slotmachine.GumRuntimes.DefaultForms.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as Slotmachine.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as Slotmachine.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as Slotmachine.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as Slotmachine.GumRuntimes.ContainerRuntime;
