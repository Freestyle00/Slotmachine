...
{
    public partial class Slot2 : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable
    {
        ...
        public Entities.Slot2.VariableState CurrentState
        {
            get
            {
            ...
            {
                mCurrentState = value;
                if (CurrentState == VariableState.adiamondshowing)
                {
                    SpriteInstanceTexture = adiamond;
                }
                else if (CurrentState == VariableState.abariguessshowing)
                {
        ...
        public Slot2 (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Slot2 (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("Slot2StaticUnload", UnloadStaticContent);
                        mRegisteredUnloads.Add(ContentManagerName);
                    }
                }
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/frb_icon.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                FRB_icon = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/frb_icon.png", ContentManagerName);
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/veilstone_corner_moon_stone.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                Veilstone_Corner_Moon_Stone = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/veilstone_corner_moon_stone.png", ContentManagerName);
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/something.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                something = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/something.png", ContentManagerName);
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/bariguess.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                Bariguess = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/bariguess.png", ContentManagerName);
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/adiamond.png", ContentManagerName))
                {
                    registerUnload = true;
                }
                adiamond = FlatRedBall.FlatRedBallServices.Load<Microsoft.Xna.Framework.Graphics.Texture2D>(@"content/entities/slot2/adiamond.png", ContentManagerName);
                if (!FlatRedBall.FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/slot2/rollingslotsforall.achx", ContentManagerName))
                {
                    registerUnload = true;
                }
                RollingSlotsforall = FlatRedBall.FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/slot2/rollingslotsforall.achx", ContentManagerName);
            }
        ...
        {
            if (stateToInterpolateTo == VariableState.adiamondshowing)
            {
            }
            else if (stateToInterpolateTo == VariableState.abariguessshowing)
            {
            }
        ...
        {
            if (stateToStop == VariableState.adiamondshowing)
            {
            }
            else if (stateToStop == VariableState.abariguessshowing)
            {
            }
        ...
        public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
        {
            ...
            #endif
            if (firstState == VariableState.adiamondshowing)
            {
            ...
            else if (firstState == VariableState.abariguessshowing)
            {
                if (interpolationValue < 1)
                {
            ...
            if (secondState == VariableState.adiamondshowing)
            {
                if (interpolationValue >= 1)
                {
                    this.SpriteInstanceTexture = adiamond;
            ...
            else if (secondState == VariableState.abariguessshowing)
            {
                if (interpolationValue >= 1)
                {
                    this.SpriteInstanceTexture = Bariguess;
